...
public class Owner extends Person {
	...
	/**
	 * Check whether the owner has a pet with the given name (case-insensitive). Returns
	 * false when name is null or when no match is found. This method is read-only and
